...
public class ChatbotFragment extends AppCompatActivity {
    ...
    private static String TAG = "ChatbotFragment";
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(ChatbotFragment.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(ChatbotFragment.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(ChatbotFragment.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
